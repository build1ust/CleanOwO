<h2 align='center'>"owo farm bot"</h2>
<h3 align='center'>probably a token logger</h3>

don't trust random code off the internet<br>
but im silly so we've deobfuscated it
